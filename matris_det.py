# 2*2lik bir matrisin determinantını bulan fonksiyon
matrix_1=[[1,2],[3,4]]
...
#1 satır 1 sütun silen fonksiyon
def delete_row_col_from_matrix(m_1,m,n):
  ...
  for i in range(size_1):
    if(i==m):
      continue #tekrar i yi arttır -> aşağıya gitme yukarı çık
    row_1=[]
...
#3*3 lük matrisin determinantını bulan fonk
...
#4*4 lük atrsin determinantını bulan fonk
